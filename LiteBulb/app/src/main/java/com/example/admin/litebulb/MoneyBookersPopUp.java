...
public class MoneyBookersPopUp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentHolder = inflater.inflate(R.layout.fragment_money_bookers_pop_up, container,
                false);
        user_id = getArguments().getInt("user_id");
        amount=getArguments().getString("amount");
        et_address=(EditText) parentHolder.findViewById(R.id.moneybookers_address);
