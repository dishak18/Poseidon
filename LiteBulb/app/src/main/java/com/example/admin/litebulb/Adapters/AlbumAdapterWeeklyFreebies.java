...
public class AlbumAdapterWeeklyFreebies extends RecyclerView.Adapter<AlbumAdapterWeeklyFreebies.MyViewHolder> {
    ...
    public AlbumAdapterWeeklyFreebies(Context mContext, List<album> albumList) {
