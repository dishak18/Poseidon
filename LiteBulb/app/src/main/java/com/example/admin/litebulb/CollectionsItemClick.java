...
import com.example.admin.litebulb.Adapters.AdapterCollectionsFoldersItems;
...
public class CollectionsItemClick extends Fragment {
    private RecyclerView rvCollectionsFolderItems;
    private AdapterCollectionsFoldersItems adapter_collections_folder_items;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter_collections_folder_items = new AdapterCollectionsFoldersItems(getActivity(), collections_folder_items_list);
