...
public class FollowerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // Log.e("Follower Fragment", "this is username: "+loginPreferences.getString("username", ""));
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++) {
                    ...
                    for(int j=0; j<user_ids_array.length; j++)
                    {
                        if(user_id_user.equals(user_ids_array[j]))
                        {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++) {
                    ...
                    int follow_id = person.getInt("follow_id");
                    if(user_id==follow_id)
                    {
                        follow_ids.add(user_id_users_followers+"");
                    }
                }
                user_ids_array = follow_ids.toArray(new String[follow_ids.size()]);
