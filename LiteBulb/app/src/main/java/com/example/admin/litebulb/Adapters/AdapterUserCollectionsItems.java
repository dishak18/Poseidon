...
public class AdapterUserCollectionsItems extends RecyclerView.Adapter<AdapterUserCollectionsItems.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView tv_item_name, tv_categories, tv_user_name, tv_sales_items, tv_price, tv_trash;
        public ImageView thumbnail;
        ...
        public MyViewHolder(View view) {
            ...
            tv_trash=(TextView) view.findViewById(R.id.trash);
            ...
            tv_trash.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    alert.setMessage("Are you sure you want to delete this item from your collection?");
                    alert.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            dialog.dismiss();
                            Toast.makeText(mContext, "Deleting Item From Collection...", Toast.LENGTH_LONG).show();
    ...
    public AdapterUserCollectionsItems(Context mContext, List<CollectionsFolderItems> collectionsItemsList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_user_collections_folder_items, parent, false);
