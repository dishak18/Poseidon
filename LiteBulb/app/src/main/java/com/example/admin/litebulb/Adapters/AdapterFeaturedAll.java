...
public class AdapterFeaturedAll extends RecyclerView.Adapter<AdapterFeaturedAll.MyViewHolder>  {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Log.e("ADAPTERFEATURED_ALL", "this has been clicked");
    ...
    public AdapterFeaturedAll(Context mContext, List<album> albumList) {
